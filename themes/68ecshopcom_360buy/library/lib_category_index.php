...
{ 
	...
	{ 
		if ($row_c['promote_price'] >0 && $row_c['promote_start_date'] < gmtime() && gmtime() < $row_c['promote_end_date']) 
		{ 
			$arr[$row['cat_id']]['children'][$row_c['goods_id']]['promote_price'] = price_format($row_c['promote_price']); 
