...
class SplitWord
{
    ...
    function __construct($source_charset='utf-8', $target_charset='utf-8', $load_all=TRUE, $source='')
    {
        ...
        if(file_exists(ROOT_PATH . 'includes/'.$this->mainDicFile)) $this->isUnpacked = TRUE;
    ...
    */
    ...
    {
		$this->addonDicFile = ROOT_PATH . 'includes/'.$this->addonDicFile;
		$this->mainDicFile = ROOT_PATH . 'includes/'.$this->mainDicFile;
		$this->mainDicFileZip = ROOT_PATH . 'includes/'.$this->mainDicFileZip;
...
//     	$zip = new zip();
//     	//echo $targetfile;
//     	$unpackagefile = array_keys($zip->Extract($targetfile,ROOT_PATH . 'includes/data/'));
//     	//exit();
//     	$this->MakeDict(ROOT_PATH . 'includes/data/'.$unpackagefile[0]);
//     	unlink(ROOT_PATH . 'includes/data/'.$unpackagefile[0]);
//     	return true;
     }
}
