...
//    }
    ...
    if ('confirm' == $operation)
    {
        /* 标记订单为已确认 */
        //update_order($order_id, array('order_status' => OS_CONFIRMED, 'confirm_time' => gmtime()));
        update_order2($order_id,$order['total_fee']);
        update_order_amount($order_id);
       ...
       /*  $arr = array(
		...
		/* 计算并收回积分 */
			...
			if($order['order_status']==5){
			 log_account_change($order['user_id'], 0, 0,  (-1)*intval($integral['rank_points']),  (-1)*intval($integral['custom_points']), sprintf($_LANG['order_gift_integral'], $order['order_sn']));			
			}
...
function order_list()
{
    ...
    if ($result === false)
    {
        ...
        $sql = "SELECT o.order_id, o.order_sn, o.add_time, o.order_status, o.shipping_status, o.order_amount, o.money_paid," .
                    "o.pay_status, o.consignee, o.address, o.email, o.tel, o.extension_code, o.extension_id, o.order_type," .
