...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
	...
	$is_diy = empty($_POST['is_diy']) ? '0' : $_POST['is_diy'];
	
	if($is_diy=='1'){
		$diy_price=get_linked_goods_diy($_REQUEST['goods_id']);
		$shop_price=$diy_price;
	}
    ...
    if ($is_insert)
    {
        ...
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (is_diy, goods_name, goods_name_style, goods_sn, " .
                ...
                "VALUES ('$is_diy', '$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
	...
	change_linked_goods_diy($_REQUEST['goods_id']);
	}
    /* 商品编号 */
